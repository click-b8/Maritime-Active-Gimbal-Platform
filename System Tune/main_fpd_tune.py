...
if not LIVE_PLOT:
    ...
    _period_buf_roll = collections.deque(maxlen=300)
    _period_buf_ptch = collections.deque(maxlen=300)
    ...
    def _update(_frame):
        ...
        if pt_r or pt_p:
            ...
            axes[4].set_title(
                f"Wave period (IMU2 boat reference)  —  Roll: {last_r}   Pitch: {last_p}",
